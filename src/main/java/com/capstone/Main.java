...
public class Main {
    public static void main(String[] args){
        ...
        System.out.printf("║******************** \uD83D\uDCB0\uD83D\uDCB0"+RED+BOLD+UNDERLINE+"SALESCORP LEDGER APP"+RESET+CYAN+"\uD83D\uDCB0\uD83D\uDCB0 *********************║%n");
        System.out.printf("║************** \uD83D\uDCB0\uD83D\uDCB0"+RED+BOLD+UNDERLINE+"INTERNATIONAL LOGISTICS PROVIDER"+RESET+CYAN+"\uD83D\uDCB0\uD83D\uDCB0 ***************║%n");
